...
Then we could use the plot to determine the sample size. We should focus on the trends of the plots because the results produced by synthetic data are usually better than true data, but the trends are pretty similar.
