...
```{r echo=FALSE, fig.cap="Workflow of the SSD package", out.width = '110%', fig.align = 'center'}
...
```{r echo=FALSE, fig.cap="JackStrawPlot of the pilot data", out.width = '100%', fig.align = 'center'}
knitr::include_graphics("pbmc_jackstrawplot_pilot.png")
```
```{r echo=FALSE, fig.cap="ElbowPlot of the pilot data", out.width = '80%', fig.align = 'center'}
...
```{r echo=FALSE, fig.cap="JackStrawPlot of the true training data", out.width = '110%', fig.align = 'center'}
knitr::include_graphics("pbmc_jackstrawplot.jpeg")
```
```{r echo=FALSE, fig.cap="ElbowPlot of the true training data", out.width = '80%', fig.align = 'center'}
...
```
```{r echo=FALSE, fig.cap="the result plot of the default setting", out.width = '100%', fig.align = 'center'}
...
```
```{r echo=FALSE, fig.cap="the result plot of the self-defined function setting", out.width = '100%', fig.align = 'center'}
