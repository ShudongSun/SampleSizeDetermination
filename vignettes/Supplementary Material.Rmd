...
```
```{r echo=FALSE, fig.cap="the result plot of the default setting", out.width = '100%'}
...
```
```{r echo=FALSE, fig.cap="the result plot of the self-defined function setting", out.width = '100%'}
...
```
```{r echo=FALSE, fig.cap="the result plots of comparison using 'ARI' as the index", out.width = '80%'}
...
```
```{r echo=FALSE, fig.cap="the result plots of comparison using 'classification error' as the index", out.width = '80%'}
...
result_true_13 = ssd(x=x_true_train, y=y_true_train, model = "randomforest", index="AMI",
                     ...
                     test_x=x_true_test,test_y=y_true_test, n_test=100)
```
```{r echo=FALSE, fig.cap="the result plots of comparison using 'AMI' as the index", out.width = '80%'}
